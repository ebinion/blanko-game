...
- [X] T044 [US3] Ensure the results page renders the score `<Card>` *before* the review list in the DOM, so screen-reader users hear the outcome before the per-item details (FR-029); verify via `tests/e2e/review.spec.ts`.
